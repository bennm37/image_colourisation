...
import app.coloriser as Coloriser
import app.popup as waitingWindowClass
...
class imageColoriser(ctk.CTkFrame):
    ...
    def createUI(self):
        ...
        self.rawImageExists: bool = False
        self.grayImageWithSomeColorExists: bool = False
        self.fileName: str = "Select file"
        self.statePath: str = "../states/apple.pkl"
    ...
    def generateFrames(self):
        ...
        self.toolbar = Toolbar(self.canvas, self.imageFrame)
